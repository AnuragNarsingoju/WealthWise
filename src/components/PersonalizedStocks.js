                            ...
                            >
                               ...
                               {field.type === 'select' ? (
                                    <select
                                        ...
                                        className="w-full pl-12 pr-4 py-3 bg-zinc-800 border border-zinc/30 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-white/50 focus:ring-2 focus:ring-green-500/50 transition-all duration-300"
                                        required
                                    >
